...
const Resume: React.FC = () => {
  ...
  return (
    <section id="resume" className="py-20 bg-slate-50 dark:bg-slate-900 transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4">Resume</h2>
            ...
            <div className="p-8">
              ...
              <div className="text-center mb-8">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-8">
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-slate-700 rounded-lg">
                    <div className="text-2xl font-bold text-blue-600 dark:text-purple-400">8.5</div>
